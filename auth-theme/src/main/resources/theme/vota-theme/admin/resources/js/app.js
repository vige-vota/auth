...
var module = angular.module('keycloak', [  'keycloak.services', 'vota.services', 'keycloak.loaders', 'ui.bootstrap', 'ui.select2', 'angularFileUpload', 'angularTreeview', 'pascalprecht.translate', 'ngCookies', 'ngSanitize', 'ui.ace']);
...
module.config([ '$routeProvider', function($routeProvider) {
    $routeProvider
        ...
        .when('/create/vota/:realm', {
            templateUrl : resourceUrl + '/partials/vota-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
        ...
        .when('/realms/:realm/rooms/:vota', {
            templateUrl : resourceUrl + '/partials/vota-detail.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
                vota : function(VotaLoader) {
                    return VotaLoader();
                }
            },
            controller : 'VotaDetailCtrl'
        ...
        .when('/realms/:realm/rooms/:vota/vota-rooms', {
            templateUrl : resourceUrl + '/partials/vota-rooms.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
...
module.directive('kcTabsVota', function () {
    return {
        scope: true,
        restrict: 'E',
        replace: true,
        templateUrl: resourceUrl + '/templates/kc-tabs-vota.html'
    }
});
