...
<head>
    ...
    <script src="${resourceUrl}/js/vota-app.js" type="text/javascript"></script>
    ...
    <script src="${resourceUrl}/js/controllers/vota-users.js" type="text/javascript"></script>
    ...
    <script src="${resourceUrl}/js/vota-services.js" type="text/javascript"></script>
