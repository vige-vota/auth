    ...
    <#elseif section = "form">
        <form id="kc-register-form" class="${properties.kcFormClass!}" action="${url.registrationAction}" method="post">
            ...
            <div class="${properties.kcFormGroupClass!}">
   				<div class="${properties.kcLabelWrapperClass!} ${messagesPerField.printIfExists('user.attributes.vota',properties.kcFormGroupErrorClass!)}">
       				<label for="user.attributes.vota" class="${properties.kcLabelClass!}">${msg("vota")}</label>
   				</div>
   				<div class="${properties.kcInputWrapperClass!}">
       				<select id="votasSelector" name="user.attributes.vota">
        				<#list votas as key,value>
    	...
    	<script>
      		(function() {
      			...
      			var votaselect = document.getElementById("votasSelector");
      	    	roomsSelect(votaselect);
  				votaselect.onchange = function() {
  					roomsSelect(votaselect);
    			};
			})();
    	</script>
